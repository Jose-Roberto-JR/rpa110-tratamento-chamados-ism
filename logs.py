from config import LOG_FALHA, RPA_DIR_PRINT, LOG_MESSAGES, RPA_FULL_NAME
...
def salvar_log_erro(bot: webdriver.Chrome = None) -> list:
    """
    ...
    if LOG_FALHA in error_message:  # Erro mapeado
        ...
        error_message = [LOG_FALHA, log_message, error_seq]

    # Print de tela caso o objeto bot != None
    try:
        file_name = fr'{RPA_DIR_PRINT}/{error_seq}.png'
        png = bot.get_screenshot_as_png()
        with open(file_name, "wb") as f:
            f.write(png)
    except Exception as error:
        print("Falha ao tirar o print do erro:" + str(error))
        pass
